...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (
    ...
    createElementBlock(
      ...
      [
        !!$setup.formData.id && !!$setup.onlineExtConfigJson.reportPrintShow
          ? (openBlock(),
        ...
        $setup.hasSubTable && $props.showSub
          ? (openBlock(),
            createBlock(
              _component_a_tabs,
              {
                              ...
                              sub.relationType == 1
                                ? (openBlock(),
                                  createElementBlock(
                                    ...
                                    [
                                      createVNode(
                                        _component_online_sub_form_detail,
                                        {
                                          table: sub.key,
                                        ...
                                        null,
                                        8,
                                        ['table', 'form-template', 'main-id', 'properties']
                                      ),
                                    ],
                                    4
                                  ))
                                    ...
                                    $setup.showStatus[sub.key]
                                      ? (openBlock(),
                                        createBlock(
                                          ...
                                          null,
                                          8,
                                          ['height', 'columns', 'dataSource', 'authPre']
                                        ))
                                      : (openBlock(),
                                        createBlock(_component_a_spin, {
                                          key: 1,
                                          spinning: true,
                                        })),
                                  ])),
