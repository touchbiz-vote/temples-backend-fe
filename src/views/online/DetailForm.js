        ...
        createVNode(_component_a_row, null, {
          default: withCtx(() => [
            ...
            createElementBlock(
              Fragment,
              null,
              renderList(_ctx.schemas, (item, index) => {
                return (
                  openBlock(),
                  createBlock(
                    _component_a_col,
                          ...
                          item.isHtml
                            ...
                            ? (openBlock(),
                              createElementBlock('div', _hoisted_4, [
                                !_ctx.detailFormData[item.field]
                                  ? (openBlock(), createElementBlock('span', _hoisted_5))
                                  : (openBlock(),
                                    createBlock(
                                      _component_link_table_card,
                                      {
                                        key: 1,
                                        disabled: '',
                                        detail: '',
                                      ...
                                      null,
                                      8,
                                      ['value', 'valueField', 'textField', 'tableName', 'multi']
                                    )),
                              ]))
                            : item.isImage
                            ? (openBlock(),
                              createElementBlock('div', _hoisted_6, [
                                createElementVNode('div', _hoisted_7, [
                                  ...
                                  createElementBlock(
                                    Fragment,
                                    null,
                                    renderList(_ctx.detailFormData[item.field], (url) => {
                                      return (
                                        openBlock(),
                                            ...
                                            createElementVNode('div', _hoisted_16, [
                                              createElementVNode('div', _hoisted_17, [
                                                createElementVNode('span', _hoisted_18, [
                                                  createElementVNode('div', _hoisted_19, [createVNode(_component_paper_clip_outlined)]),
                                                  createElementVNode(
                                                    'a',
                                                    {
                                                      href: url,
                                                    ...
                                                    toDisplayString(_ctx.getFilename(url)),
                                                    9,
                                                    _hoisted_20
                                                  ),
...
var DetailForm = /* @__PURE__ */ _export_sfc(_sfc_main, [
  ['render', _sfc_render],
  ['__scopeId', 'data-v-47915cc7'],
]);
