...
import {
  O as OnlineSubForm,
  a as OnlinePopModal,
  b as useOnlineFormContext,
  c as useFormItems,
  d as useEnhance,
  l as loadFormFieldsDefVal,
  g as getRefPromise,
  V as VALIDATE_FAILED,
  S as SUBMIT_FLOW_KEY,
  e as SUBMIT_FLOW_ID,
  f as ONL_FORM_TABLE_NAME,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (
    ...
    createElementBlock(
      ...
      [
        !!$setup.dbData.id && !!$setup.onlineExtConfigJson.reportPrintShow
          ? (openBlock(),
            createElementBlock('div', _hoisted_2, [
              createVNode(
                _component_PrinterOutlined,
                {
                  title: '\u6253\u5370',
              ...
              },
              {
                default: withCtx(() => [
                  ...
                  createElementBlock(
                    Fragment,
                    null,
                    renderList($setup.subTabInfo, (sub, index) => {
                      return (
                        openBlock(),
                        createBlock(
                                  ...
                                  createElementBlock(
                                    'div',
                                    {
                                      ...
                                      style: normalizeStyle({
                                        'overflow-y': 'auto',
                                        'overflow-x': 'hidden',
                                        'max-height': $setup.subFormHeight + 'px',
                                      }),
                                    },
                                    [
                                      createVNode(
                                        _component_online_sub_form,
                                        {
                                          ref_for: true,
                                ...
                                : (openBlock(),
                                  createElementBlock('div', _hoisted_3, [
                                    createVNode(
                                      ...
                                      },
                                      {
                                        toolbarSuffix: withCtx(() => [
                                          createVNode(
                                            ...
                                            {
                                              default: withCtx(() => [createVNode(_component_diff_outlined)]),
                                              _: 2,
                                            },
                                            1032,
                                            ['onClick']
                                          ...
                                          createVNode(
                                            ...
                                            {
                                              default: withCtx(() => [createVNode(_component_form_outlined)]),
                                              _: 2,
                                            },
                                            1032,
                                            ['onClick']
                                      ...
                                      1032,
                                      ['height', 'disabled', 'columns', 'dataSource', 'onValueChange', 'authPre', 'onAdded', 'onExecuteFillRule']
                                    ),
                                  ])),
                            ]),
                            _: 2,
        ...
        createVNode(
          ...
          null,
          8,
          ['request', 'id', 'onRegister', 'onSuccess']
        ),
      ],
      8,
      _hoisted_1
...
var OnlineForm$1 = /* @__PURE__ */ Object.freeze(
