<template>
  <div>
    ...
    <a-modal :visible="visible" :maskClosable="false" @cancel="hideModal">
      ...
      <template #title>
        <a-space>
          ...
          <a-switch checked-children="tid模式" un-checked-children="默认" v-model:checked="tidMode" @change="onModeChange" />
